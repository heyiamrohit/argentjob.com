...
class _ProfilePageState extends State<SignUpSeeker> {
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      // prov.signUp(emailController.text, phoneController.text, fnameController.text);
                      Navigator.pushNamed(context, AllJobs.routeName);
                    }
                  },
