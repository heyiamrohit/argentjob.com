...
import 'package:tatkal_jobs_app/screens/JobDesc_WithouApply.dart';
import 'package:tatkal_jobs_app/screens/Job_Description_Screen.dart';

class AllJobsNoApplyCard extends StatelessWidget {
  const AllJobsNoApplyCard({Key? key, required this.jobPost}) : super(key: key);
                ...
                TextButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (ctx) => JobDetailNoApplyWidget(
                                jobPost,
                              )));
                    },
                    child: Padding(
